...
-- ------------------------------------------------------------------
CREATE TABLE StrumentoSede (
    Strumenti VARCHAR(20),
    Sede INT,
    PRIMARY KEY (Strumento , Sede),
...
CREATE TABLE Ricetta (
    ...
    CHECK (Quantita >= 0),
    FOREIGN KEY (IngredientePrincipale)
...
CREATE TABLE OrdineVariazione(
    ...
    on DELETE CASCADE,
	FOREIGN KEY (IdVariazione) REFERENCES VariazioniPiatto(IdVarazione)
    on DELETE CASCADE
)ENGINE=INNODB DEFAULT CHARSET=latin1;
